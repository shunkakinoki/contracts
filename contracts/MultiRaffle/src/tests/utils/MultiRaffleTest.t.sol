...
import "./Hevm.t.sol"; // hevm
import "./DSTestExtended.t.sol"; // DSTest + more assertions
import "./MultiRaffleUser.t.sol"; // Raffle user
...
contract MultiRaffleTest is DSTestExtended {
  ...
  function standardEnterRaffle(uint256 numAliceTickets, uint256 numBobTickets)
    public
  {
    setTimeDuringRaffle();
