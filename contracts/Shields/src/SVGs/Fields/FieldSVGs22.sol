...
contract FieldSVGs22 is IFieldSVGs, ICategories {
  ...
  function field_285(uint24[4] memory colors)
    public
    pure
  ...
  function field_286(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_287(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_288(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_289(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
