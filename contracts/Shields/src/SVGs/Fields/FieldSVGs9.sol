...
contract FieldSVGs9 is IFieldSVGs, ICategories {
  ...
  function field_171(uint24[4] memory colors)
    public
    pure
  ...
  function field_172(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_173(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_174(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_175(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_176(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_177(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
