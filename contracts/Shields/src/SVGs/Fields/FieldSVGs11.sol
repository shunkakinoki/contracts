...
contract FieldSVGs11 is IFieldSVGs, ICategories {
  ...
  function field_194(uint24[4] memory colors)
    public
    pure
  ...
  function field_195(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_196(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_197(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_198(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
