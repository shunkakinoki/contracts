...
contract FieldSVGs16 is IFieldSVGs, ICategories {
  ...
  function field_224(uint24[4] memory colors)
    public
    pure
  ...
  function field_225(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_226(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_227(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
