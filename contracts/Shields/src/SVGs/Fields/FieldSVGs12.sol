...
contract FieldSVGs12 is IFieldSVGs, ICategories {
  ...
  function field_199(uint24[4] memory colors)
    public
    pure
  ...
  function field_200(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_201(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_202(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_203(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_204(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_205(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
