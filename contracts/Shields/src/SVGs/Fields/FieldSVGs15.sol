...
contract FieldSVGs15 is IFieldSVGs, ICategories {
  ...
  function field_218(uint24[4] memory colors)
    public
    pure
  ...
  function field_219(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_220(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_221(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_222(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_223(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
