...
contract FieldSVGs17 is IFieldSVGs, ICategories {
  ...
  function field_228(uint24[4] memory colors)
    public
    pure
  ...
  function field_229(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_230(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_231(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_232(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_233(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
