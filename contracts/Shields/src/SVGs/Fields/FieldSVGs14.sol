...
contract FieldSVGs14 is IFieldSVGs, ICategories {
  ...
  function field_212(uint24[4] memory colors)
    public
    pure
  ...
  function field_213(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_214(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_215(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_216(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_217(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
