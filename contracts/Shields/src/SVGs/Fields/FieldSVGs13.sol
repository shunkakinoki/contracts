...
contract FieldSVGs13 is IFieldSVGs, ICategories {
  ...
  function field_206(uint24[4] memory colors)
    public
    pure
  ...
  function field_207(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_208(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_209(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_210(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_211(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
