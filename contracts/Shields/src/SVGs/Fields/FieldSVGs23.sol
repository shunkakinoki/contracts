...
contract FieldSVGs23 is IFieldSVGs, ICategories {
  ...
  function field_290(uint24[4] memory colors)
    public
    pure
  ...
  function field_291(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_292(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_293(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_294(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_295(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_296(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_297(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_298(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
