...
contract FieldSVGs21 is IFieldSVGs, ICategories {
  ...
  function field_276(uint24[4] memory colors)
    public
    pure
  ...
  function field_277(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_278(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_279(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_280(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_281(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_282(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_283(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
  ...
  function field_284(uint24[4] memory colors)
    public
    pure
    returns (FieldData memory)
  {
