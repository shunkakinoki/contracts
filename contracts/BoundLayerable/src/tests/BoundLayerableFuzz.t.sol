...
import { BoundLayerableTestImpl } from "../implementations/BoundLayerableTestImpl.sol";
...
import { ArrayLengthMismatch, LayerNotBoundToTokenId, MultipleVariationsEnabled, DuplicateActiveLayers } from "../interface/Errors.sol";
...
contract BoundLayerableFuzzTest is Test, BoundLayerableEvents {
  ...
  function testFuzzCheckUnpackedIsSubsetOfBound(
    ...
    // check should revert
    vm.expectRevert(abi.encodeWithSelector(LayerNotBoundToTokenId.selector));
