...
contract TestTokenTest is Test, ERC721Recipient {
  ...
  function testDoTheMost() public {
    ...
    packedDistributions = PackedByteUtility.packArrayOfBytes(_distributions);
    ...
    _distributions = distributions;
    packedDistributions = PackedByteUtility.packArrayOfBytes(_distributions);
    test.setLayerTypeDistribution(uint8(LayerType.OBJECT), packedDistributions);
    ...
    _distributions = distributions;
    packedDistributions = PackedByteUtility.packArrayOfBytes(_distributions);
    test.setLayerTypeDistribution(uint8(LayerType.BORDER), packedDistributions);
